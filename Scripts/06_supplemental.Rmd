...
```{r blups-table-cnj02, echo=FALSE, message=FALSE, include=TRUE, results='asis', out.width="85%"}
load(file=paste0(cnj02_workflow,"/.RData.01_genBLUP"))
clabel <- knitr::opts_current$get('label')
caption <- "CNJ02 Population Complete Trait and BLUP Summary."
#tbl <- generateFullTable(model.collated.summary.wide.tb, caption=caption, tfont_size=table.font_size)
#print_table(tbl, clabel, caption)
```

### CNJ04 - BLUP Summary Statistics - Complete

```{r blups-table-cnj04, echo=FALSE, message=FALSE, include=TRUE, results='asis', out.width="85%"}
load(file=paste0(cnj04_workflow,"/.RData.01_genBLUP"))
clabel <- knitr::opts_current$get('label')
caption <- "CNJ04 Population Complete Trait and BLUP Summary."
#tbl <- generateFullTable(model.collated.summary.wide.tb, caption=caption, tfont_size=table.font_size)
#print_table(tbl, clabel, caption)
```
...
```{r qtl-table-scanone-cnj02, echo=FALSE, message=FALSE, include=TRUE, results='asis', out.width="85%"}
load(file=paste0(cnj02_workflow,"/.RData.12_geneffects.2"))
clabel <- knitr::opts_current$get('label')
caption <- "CNJ02 Population Top 2 QTL for all Trait x Model combinations, fit using scanone() function, with effect plots."
tbl <- generateTable(effs.complete.tb %>% arrange(model,trait,desc(marker_variance)),
                     meths = "scanone",
                     caption = caption,
...
```{r qtl-table-stepwiseqtl-cnj02, echo=FALSE, message=FALSE, include=TRUE, results='asis', out.width="85%"}
load(file=paste0(cnj02_workflow,"/.RData.12_geneffects.2"))
clabel <- knitr::opts_current$get('label')
caption <- "CNJ02 Population Top 2 QTL for all Trait x Model combinations, fit using stepwiseqtl() function, with effect plots."
tbl <- generateTable(effs.complete.tb %>% arrange(model,trait,desc(marker_variance)),
                     meths = "stepwiseqtl",
                     caption = caption,
                     tfont_size = table.font_size)
...
```{r qtl-table-scanone-cnj04, echo=FALSE, message=FALSE, include=TRUE, results='asis', out.width="85%"}
load(file=paste0(cnj04_workflow,"/.RData.12_geneffects.2"))
clabel <- knitr::opts_current$get('label')
caption <- "CNJ04 Population Top 2 QTL for all Trait x Model combinations, fit using scanone() function, with effect plots."
tbl <- generateTable(effs.complete.tb %>% arrange(model,trait,desc(marker_variance)),
                     meths = "scanone",
                     caption = caption,
                     tfont_size = table.font_size)
...
```{r qtl-table-stepwiseqtl-cnj04, echo=FALSE, message=FALSE, include=TRUE, results='asis', out.width="85%"}
load(file=paste0(cnj04_workflow,"/.RData.12_geneffects.2"))
clabel <- knitr::opts_current$get('label')
caption <- "CNJ04 Population Top 2 QTL for all Trait x Model combinations, fit using stepwiseqtl() function, with effect plots."
tbl <- generateTable(effs.complete.tb %>% arrange(model,trait,desc(marker_variance)),
                     meths = "stepwiseqtl",
                     caption = caption,
                     tfont_size = table.font_size)
...
### CNJ02 Comprehensive QTL Summary Table With Effect Statistics {#cnj02-qtls}
```{r qtl-table-cnj02-copy, echo=FALSE, message=FALSE, include=TRUE}
    #Copy the appropriate data to the 'publication' folder to make it available on server
    system2("cp", args=c(paste0(cnj02_workflow,"/traits/effects_collated.csv"),"../Data/publication/tables/effects_collated.cnj02.csv"))
```
[CNJ02 QTLs](https://vaccinium.vcru.wisc.edu/maule-ch1/Data/publication/tables/effects_collated.cnj02.csv)

### CNJ04 Comprehensive QTL Summary Table With Effect Statistics {#cnj04-qtls}
```{r qtl-table-cnj04-copy, echo=FALSE, message=FALSE, include=TRUE}
    #Copy the appropriate data to the 'publication' folder to make it available on server
    system2("cp", args=c(paste0(cnj04_workflow,"/traits/effects_collated.csv"),"../Data/publication/tables/effects_collated.cnj04.csv"))
```
[CNJ04 QTLs](https://vaccinium.vcru.wisc.edu/maule-ch1/Data/publication/tables/effects_collated.cnj04.csv)

### Interactive QTL Browser

* [CNJ02](https://vaccinium.vcru.wisc.edu/circos-cnj02)
* [CNJ04](https://vaccinium.vcru.wisc.edu/circos-cnj04)
