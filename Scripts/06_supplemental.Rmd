...
```{r blups-table-cnj02, echo=FALSE, message=FALSE, include=TRUE, results='asis', out.width="75%"}
load(file=paste0(params$cnj02_workflow,"/.RData.01_genBLUP"))
full_tbl_all_flex  <- generateFullTableFlex(model.collated.summary.wide.tb, caption="CNJ02 Population Complete Trait and BLUP Summary.")
knitr::knit_print(full_tbl_all_flex)
```

### CNJ04 - BLUP Summary Statistics - Complete
```{r blups-table-cnj04, echo=FALSE, message=FALSE, include=TRUE, results='asis', out.width="75%")
load(file=paste0(params$cnj04_workflow,"/.RData.01_genBLUP"))
full_tbl_all_flex  <- generateFullTableFlex(model.collated.summary.wide.tb, caption="CNJ04 Population Complete Trait and BLUP Summary.")
knitr::knit_print(full_tbl_all_flex)
```
...
generateTable(qtl.collated.succinct.tb %>% 
