...
percent, with an average BLUP variance explained by all fitted QTLs per *trait × model* of `r qtls.cnj02.sw.modv` percent.
...
emerges as with the yield-related traits.

 A [complete listing](#cnj02-qtls)
...
percent, with an average BLUP variance explained by all QTLs per *trait × model* of `r qtls.cnj04.sw.modv` percent.
...
paternal side, with a 14.21 $\frac{mg}/{100mg\ fruit}$ advantage of allele *D* over *C*.  Also as in CNJ02, the largest significant
QTL for *total yield* is found on linkage group 12 and position 48.76cM, with genotype *AC* showing the largest genotype
