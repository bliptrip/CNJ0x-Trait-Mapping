...
tar -xzf qtl_pipeline_02_runperms.datafiles.tar.gz
...
R CMD BATCH '--args process='$1' seed='$seed' n.perms='$nperms'  query_mmers='$mmers'  query_traits='$traits'  query_subtraits='$subtraits'' qtl_pipeline_02_runperms.R
